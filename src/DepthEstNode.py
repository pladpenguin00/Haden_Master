...
while (1==1):
	...
	#assume these come in together in matrix
	bbox= rostopic bbox
	rocognized= rostopic rocognizedobj
	
	countobj=len(bbox);
	for i in xrange(0,countobj):
		imgdata[newimage]['recognized object'] = recognized	
